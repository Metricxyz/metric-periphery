...
abstract contract MetricOmmPoolDataProviderTestBase is Test, PoolInitPreprocessor {
    ...
    )
  {
    ...
    router = new MetricOmmSimpleRouter(address(new MockWETH9()), address(factoryStub), address(0));
  ...
  function _trySimulateSwapDeltas(
    ...
    try IMetricOmmPool(pool)
      .simulateSwapAndRevert(
        address(this), address(this), zeroForOne, amountSpecified, priceLimitX64, bidX64, askX64, refX64, hex""
      ) {
